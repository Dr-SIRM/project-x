  ...
  return (
    <Box m="20px">
      ...
      <Formik
        ...
        initialValues={{
          ...Object.keys(availabilityData).reduce((acc, key) => {
            acc[key] = availabilityData[key] || "";
            return acc;
          }, {}),
        }}
      >
              ...
              {Array.from({ length: 7 }).map((_, rowIndex) => (
                <>
                  ...
                  {Array.from({ length: 6 }).map((_, columnIndex) => (
                    <TextField
                      key={`day_${rowIndex + 1}_${columnIndex}`}
                      fullWidth
                      variant="filled"
                      type="time"
                      onBlur={handleBlur}
                      onChange={handleChange}
                      value={values[`day_${rowIndex + 1}_${columnIndex}`] || ""}
                      name={`day_${rowIndex + 1}_${columnIndex}`}
                      error={
                        !!touched[`day_${rowIndex + 1}_${columnIndex}`] &&
                        !!errors[`day_${rowIndex + 1}_${columnIndex}`]
                      }
                      helperText={
                        touched[`day_${rowIndex + 1}_${columnIndex}`] &&
                        errors[`day_${rowIndex + 1}_${columnIndex}`]
      ...
      <Snackbar
        ...
        message="Error occurred - Please check your data and try again"
        autoHideDuration={3000}
        sx={{
