from flask import render_template, current_app, request, redirect, flash, url_for, abort, session
...
def invite():
    ...
    if request.method == 'POST':
        ...
        data = RegistrationToken(id=new_id, 
                                 ...
                                 token=random_token, 
                                 company_name=data_form.company_name.data, 
                                 department=data_form.department.data, 
                                 employment=data_form.employment.data, 
                                 employment_level=data_form.employment_level.data, 
                                 access_level=data_form.access_level.data, 
